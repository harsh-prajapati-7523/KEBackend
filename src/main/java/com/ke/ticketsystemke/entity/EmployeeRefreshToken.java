...
@Entity
@Table(
        name = "employee_refresh_tokens",
        indexes = {
                @Index(name = "idx_employee_refresh_tokens_token_hash", columnList = "token_hash", unique = true),
                @Index(name = "idx_employee_refresh_tokens_employee", columnList = "employee_id")
        }
)
